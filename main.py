...
OWNER_ID = 7788212890 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [5302639580,6187058869]

AUTH_CHANNEL = -1002458238039
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳RANA_JII🇮🇳" ,url=f"https://t.me/Ranajii25") ],
                    [
                    InlineKeyboardButton("🔔MY WORLD🔔" ,url="https://t.me/be_positive_withme") ],
                    [
                    InlineKeyboardButton("🦋RANA_JII🦋" ,url="https://t.me/OFFICIAL_RANA_JII")                              
                ],           
            ]
      )
...
async def upload(bot: Client, m: Message):
    ...
    await editable.edit("𝗡𝗼𝘄 𝗦𝗲𝗻𝗱 𝗧𝗵𝗲 𝗧𝗵𝘂𝗺𝗯 𝗨𝗿𝗹 𝗘𝗴 » 𝗜𝗳 𝗗𝗼𝗻'𝘁 𝗪𝗮𝗻𝘁 𝗧𝗵𝘂𝗺𝗯𝗻𝗮𝗶𝗹 𝗦𝗲𝗻𝗱 = 𝗻𝗼")
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            elif "https://appx-transcoded-videos-mcdn.akamai.net.in/videos/yesofficer-data/" in url:
